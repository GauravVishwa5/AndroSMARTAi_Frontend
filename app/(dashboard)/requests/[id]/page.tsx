...
export default function RequestWorkspacePage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 rounded-2xl bg-slate-900/80 border border-slate-800/80 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Borrower: <strong className="text-slate-200">Ajay Kumar</strong> &bull; Pitampura, New Delhi &bull; Axis Bank Pitampura Branch
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 min-h-[680px]">
        ...
        <div className="lg:col-span-5 flex flex-col rounded-2xl bg-slate-900/80 border border-slate-800/80 overflow-hidden shadow-sm">
          ...
          <div className="flex-1 p-4 bg-slate-950/90 overflow-y-auto flex items-center justify-center">
            <div
              style={{ transform: `scale(${zoomLevel / 100})`, transformOrigin: 'top center' }}
              className="w-full max-w-sm rounded-xl bg-slate-900 border border-slate-700/80 p-5 shadow-2xl space-y-4 transition-transform duration-200"
            >
              {/* Document Header Stamp */}
              <div className="border-b border-slate-700 pb-3 text-center space-y-1">
                <div className="inline-block px-2.5 py-0.5 rounded bg-blue-500/20 border border-blue-500/40 text-[10px] font-bold text-blue-300 uppercase tracking-wider">
              ...
              <div className="space-y-2.5 text-[11px]">
                <div className="p-2 rounded-lg bg-blue-500/10 border border-blue-500/30 text-slate-200">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-blue-400 block mb-0.5">
                    Vendor (Transferor)
                  </span>
                  <p className="font-semibold text-white">{currentDoc.extracted.vendor}</p>
                </div>

                <div className="p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-slate-200">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-emerald-400 block mb-0.5">
                    Vendee (Purchaser / Borrower)
                  </span>
                  <p className="font-semibold text-white">{currentDoc.extracted.vendee}</p>
                </div>

                <div className="p-2 rounded-lg bg-amber-500/10 border border-amber-500/30 text-slate-200">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-amber-400 block mb-0.5">
                    Consideration & Stamp Duty
                  </span>
                  <p className="font-semibold text-white">{currentDoc.extracted.consideration}</p>
                </div>
                ...
                <div className="p-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-300">
                  ...
                  <p className="text-[10px] leading-relaxed">{currentDoc.extracted.propertyDesc}</p>
                </div>
              </div>
        ...
        <div className="lg:col-span-7 flex flex-col rounded-2xl bg-slate-900/80 border border-slate-800/80 overflow-hidden shadow-sm">
          {/* Tab Navigation Header */}
          <div className="border-b border-slate-800 bg-slate-950/60 p-2 flex items-center gap-1 overflow-x-auto">
            {[
          ...
          <div className="flex-1 p-5 overflow-y-auto">
            ...
            {activeTab === 'TIMELINE' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-bold text-white">30-Year Unbroken Chain of Title</h3>
                    <p className="text-xs text-slate-400">Sequential ownership history and title devolution graph</p>
                  </div>
                ...
                <div className="relative pl-6 space-y-6 before:absolute before:left-2.5 before:top-3 before:bottom-3 before:w-0.5 before:bg-blue-500/40">
                  ...
                  <div className="relative group">
                    <div className="absolute -left-6 top-1 w-3.5 h-3.5 rounded-full bg-blue-500 border-2 border-slate-900 shadow-sm" />
                    <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 hover:border-slate-700 transition-all space-y-1">
                      <div className="flex items-center justify-between text-xs">
                        <span className="font-bold text-white">1998 &mdash; Original Allotment (DDA)</span>
                        <span className="text-slate-400 font-mono">Reg: #1249</span>
                      </div>
                      <p className="text-xs text-slate-300">
                        DLF Housing Development &rarr; <strong className="text-blue-400">Sunil K. Sharma</strong>
                      </p>
                  ...
                  <div className="relative group">
                    <div className="absolute -left-6 top-1 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-slate-900 shadow-sm" />
                    <div className="p-4 rounded-xl bg-slate-950/60 border border-emerald-500/30 hover:border-emerald-500/50 transition-all space-y-1">
                      <div className="flex items-center justify-between text-xs">
                        <span className="font-bold text-white">2020 &mdash; Absolute Registered Sale Deed</span>
                        <span className="text-emerald-400 font-mono">Reg: #8472</span>
                      </div>
                      <p className="text-xs text-slate-300">
                        Sunil K. Sharma &rarr; <strong className="text-emerald-400">Ajay Kumar (Current Borrower)</strong>
                      </p>
                      <p className="text-[11px] text-slate-400">
                  ...
                  <div className="relative group">
                    <div className="absolute -left-6 top-1 w-3.5 h-3.5 rounded-full bg-indigo-500 border-2 border-slate-900 shadow-sm" />
                    <div className="p-4 rounded-xl bg-indigo-950/20 border border-indigo-500/30 space-y-1">
                      <div className="flex items-center justify-between text-xs">
                        <span className="font-bold text-white">2026 &mdash; Proposed Equitable Mortgage</span>
                        <span className="text-indigo-400 font-mono">Axis Bank</span>
                      </div>
                      <p className="text-xs text-slate-300">
                        Home Loan Facility: <strong className="text-indigo-300">Rs. 65,00,000</strong>
                      </p>
                      <p className="text-[11px] text-slate-400">
            ...
            {activeTab === 'EXTRACTED_OCR' && (
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-white">Structured OCR Entity Extraction</h3>
            ...
            {activeTab === 'IGR_SEARCH' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-bold text-white">IGR Registry Cross-Verification</h3>
                ...
                <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-2 text-xs">
                  <div className="flex justify-between border-b border-slate-800 pb-2">
                    <span className="text-slate-400">Portal Queried:</span>
                    <span className="text-white font-medium">Delhi DORIS / SRO Pitampura</span>
                  </div>
                  <div className="flex justify-between border-b border-slate-800 pb-2">
                    <span className="text-slate-400">Index II Registration No:</span>
                    <span className="font-mono text-blue-400 font-bold">8472 / 2020</span>
                  </div>
                  <div className="flex justify-between border-b border-slate-800 pb-2">
                    <span className="text-slate-400">Owner Recorded in SRO:</span>
                    <span className="text-emerald-400 font-bold">Ajay Kumar</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Encumbrance Recorded:</span>
                    <span className="text-emerald-400 font-bold">NIL (Unencumbered)</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'DISCREPANCIES' && (
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-white">Encumbrance & Discrepancy Audit</h3>
                <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-start gap-3">
                  <ShieldCheck className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-bold text-emerald-300">No Legal Impediments Detected</h4>
            ...
            {activeTab === 'TSR_REPORT' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-bold text-white">Title Search Report (TSR) Generator</h3>
                    <p className="text-xs text-slate-400">Institutional Bank Format &mdash; Axis Bank Standard</p>
                  </div>
                  <button
                ...
                <div className="p-5 rounded-xl bg-slate-950/80 border border-slate-800 space-y-3 text-xs leading-relaxed text-slate-300">
                  <div className="text-center border-b border-slate-800 pb-3">
                    <h4 className="text-sm font-bold text-white">LEGAL TITLE SEARCH REPORT (TSR)</h4>
                    <p className="text-[11px] text-slate-400 font-mono">File Ref: TSR-2026-DL-349 &bull; Date: 30-Aug-2026</p>
                  </div>
                  <p>
                    <strong>1. Opinion on Title:</strong> In our professional legal opinion, the Title of the Mortgagor/Borrower <strong className="text-white">Mr. Ajay Kumar</strong> to the schedule property described hereunder is <strong>CLEAR, VALID, MARKETABLE, AND UNENCUMBERED</strong>.
                  </p>
                  <p>
