  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 hover:bg-slate-800 text-xs font-semibold text-slate-300 transition-all shadow-sm"
          >
          ...
          <Link
            href="/requests/new"
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-semibold shadow-lg shadow-blue-600/25 hover:shadow-blue-600/35 transition-all"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-blue-950/40 border border-slate-800/80 hover:border-slate-700/80 transition-all shadow-sm group">
          ...
          <p className="text-[10px] text-slate-400 mt-2">Active loan origination pipeline</p>
        </div>

        {/* Pending Scrutiny */}
        <div className="p-5 rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-amber-950/40 border border-slate-800/80 hover:border-slate-700/80 transition-all shadow-sm group">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400">Pending Scrutiny</span>
          ...
          <p className="text-[10px] text-slate-400 mt-2">Avg scrutiny queue: ~4.2 hrs</p>
        </div>

        {/* Verified Titles */}
        <div className="p-5 rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950/40 border border-slate-800/80 hover:border-slate-700/80 transition-all shadow-sm group">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400">Verified Titles</span>
            <div className="w-8 h-8 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center">
              <CheckCircle className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-2xl font-extrabold text-white">1,188</span>
            <span className="text-[11px] font-semibold text-emerald-400">95.2% Clear</span>
          </div>
          <div className="mt-3 w-full bg-slate-800 rounded-full h-1.5 overflow-hidden">
            <div className="bg-emerald-500 h-1.5 rounded-full w-[95%]" />
          </div>
          <p className="text-[10px] text-slate-400 mt-2">Ready for mortgage disbursement</p>
        </div>

        {/* OCR & AI Efficiency */}
        <div className="p-5 rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950/40 border border-slate-800/80 hover:border-slate-700/80 transition-all shadow-sm group">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400">AI OCR Accuracy</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-[11px] font-semibold text-indigo-400">GPT-4 Engine</span>
          </div>
          <div className="mt-3 w-full bg-slate-800 rounded-full h-1.5 overflow-hidden">
            <div className="bg-indigo-500 h-1.5 rounded-full w-[99%]" />
          </div>
          <p className="text-[10px] text-slate-400 mt-2">Multi-page Deed & Index II parser</p>
        </div>
      </div>
        ...
        <div className="flex items-center gap-2.5">
          <div className="relative w-full md:w-64">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl pl-8 pr-3 py-1.5 text-xs text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
          </div>
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      ...
                      <p className="text-[11px] text-slate-400 mt-0.5">
                        {req.location} &bull; <span className="font-mono text-slate-400">{req.cts}</span>
                      </p>
                    </td>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center font-bold text-[10px] text-slate-200">
                          {req.ownerName[0]}
                        </div>
                        <span className="font-medium text-slate-200">{req.ownerName}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-5 py-4 text-right">
                      <Link
                        href={`/requests/${req.id}`}
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-xl bg-blue-600/15 hover:bg-blue-600/30 text-blue-400 border border-blue-500/30 text-xs font-semibold transition-all shadow-sm"
                      >
                        <span>Examine</span>
